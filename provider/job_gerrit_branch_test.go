...
func TestAccJobGerritBranchBasic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		CheckDestroy: testAccJobGerritBranchDestroy,
		Steps: []resource.TestStep{
			{
				Config: testAccJobGerritBranchConfigBasic(jobName, strategy),
			...
			{
				Config: testAccJobGerritBranchConfigBasic(jobName, newStrategy),
				Check: resource.ComposeAggregateTestCheckFunc(
...
func testAccJobGerritBranchConfigBasic(jobName string, strategy string) string {
	return fmt.Sprintf(`
...
func testAccJobGerritBranchDestroy(s *terraform.State) error {
